...
public final class EmbedMetadataLoader {
    ...
    public static Map<String, Table> loadCatalog(Map<String, VmsDataModel> vmsDataModelMap,
        ...
        for (var entry : dataSchemaToPkMap.entrySet()) {
            ...
            PrimaryIndex primaryIndex = createPrimaryIndex(entry.getKey().tableName, schema, isCheckpointing, maxRecords_);
    ...
    private static PrimaryIndex createPrimaryIndex(String tableName, Schema schema, boolean isCheckpointing, int maxRecords) {
        if(isCheckpointing){
            ...
            RecordBufferContext recordBufferContext = loadRecordBuffer(maxRecords, schema.getRecordSizeWithHeader(), tableName);
     ...
     */
    public static RecordBufferContext loadRecordBuffer(int maxNumberOfRecords, int recordSize, String fileName){
