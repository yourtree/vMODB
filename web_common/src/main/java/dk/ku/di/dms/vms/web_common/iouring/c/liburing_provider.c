...
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_createCqes(JNIEnv *env, jclass cls, jint count) {
...
JNIEXPORT jlong JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_create(JNIEnv *env, jclass cls, jint maxEvents) {
...
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_close(JNIEnv *env, jclass cls, jlong ring_address) {
    struct io_uring *ring = (struct io_uring *) ring_address;
    io_uring_queue_exit(ring);
}

JNIEXPORT jint JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_submitAndGetCqes(JNIEnv *env, jclass cls, jlong ring_address, jobject byte_buffer, jlong cqes_address, jint cqes_size, jboolean should_wait) {
    struct io_uring *ring = (struct io_uring *) ring_address;
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_freeCqes(JNIEnv *env, jclass cls, jlong cqes_address) {
    struct io_uring_cqe **cqes = (struct io_uring_cqe **) cqes_address;
    free(cqes);
}

JNIEXPORT jstring JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_getCqeIpAddress(JNIEnv *env, jclass cls, jlong cqes_address, jint cqe_index) {
    struct io_uring_cqe **cqes = (struct io_uring_cqe **) cqes_address;
    struct io_uring_cqe *cqe = cqes[cqe_index];
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_markCqeSeen(JNIEnv *env, jclass cls, jlong ring_address, jlong cqes_address, jint cqe_index) {
    struct io_uring *ring = (struct io_uring *) ring_address;
    struct io_uring_cqe **cqes = (struct io_uring_cqe **) cqes_address;
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_queueAccept(JNIEnv *env, jclass cls, jlong ring_address, jint server_socket_fd) {
    struct io_uring *ring = (struct io_uring *) ring_address;
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_queueConnect(JNIEnv *env, jclass cls, jlong ring_address, jint socket_fd, jstring ip_address, jint port) {
    struct io_uring *ring = (struct io_uring *) ring_address;
...
JNIEXPORT jlong JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_queueRead(JNIEnv *env, jclass cls, jlong ring_address, jint fd, jobject byte_buffer, jint buffer_pos, jint buffer_len, jlong io_offset) {
...
JNIEXPORT jlong JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_queueWrite(JNIEnv *env, jclass cls, jlong ring_address, jint fd, jobject byte_buffer, jint buffer_pos, jint buffer_len, jlong io_offset) {
    void *buffer = (*env)->GetDirectBufferAddress(env, byte_buffer);
    if (buffer == NULL) {
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_IoUring_queueClose(JNIEnv *env, jclass cls, jlong ring_address, jint fd) {
    struct io_uring *ring = (struct io_uring *) ring_address;
    if (io_uring_sq_space_left(ring) <= 1) {
        throw_exception(env, "io_uring_sq_space_left", -EBUSY);
        return;
...
JNIEXPORT void JNICALL
Java_dk_ku_di_dms_vms_web_1common_iouring_AbstractIoUringChannel_close(JNIEnv *env, jclass cls, jint fd) {
    shutdown(fd, SHUT_WR);
    close(fd);
}
