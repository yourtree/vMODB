...
import dk.ku.di.dms.vms.database.query.planner.operator.result.VoidOperatorResult;
import dk.ku.di.dms.vms.database.query.planner.operator.result.interfaces.IOperatorResult;
import dk.ku.di.dms.vms.database.query.planner.operator.result.meta.Status;
...
public class BulkInsert implements Consumer<IOperatorResult>, Supplier<VoidOperatorResult> {
    ...
    public VoidOperatorResult get() {
        ...
        for( AbstractEntity<?> entity : this.input.getEntities() ) {
