...
public class HibernateExporter {
    ...
    protected static Logger log = LoggerFactory.getLogger(HibernateExporter.class);
    ...
    public void export(File exportFile, boolean generateCreateQueries, boolean generateDropQueries) throws FileNotFoundException {
    ...
    protected void createHibernateConfig() {
