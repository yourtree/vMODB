...
public class ProductStockOrderWorkflowTest extends AbstractWorkflowTest {
    ...
    public void testComplexTopologyWithThreeVMSs() throws Exception {
        ...
        sleep(batchWindowInterval + 1000);
    ...
    private class InputProducer implements Runnable {
        ...
        public void run() {
            ...
            while(val < 10) {
                ...
                TransactionInput.Event eventPayload_ = new TransactionInput.Event("update_product", payload_);
                TransactionInput txInput_ = new TransactionInput("update_product", eventPayload_);
    ...
    private Coordinator loadCoordinator() throws IOException {
        ...
        transactionMap.put(checkoutDag.name, updateProductDag);
